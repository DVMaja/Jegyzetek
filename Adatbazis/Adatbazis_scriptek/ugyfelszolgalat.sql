...
/****** Object:  Database [ugyfelszolg]    Script Date: 2023. 11. 07. 8:04:43 ******/
CREATE DATABASE [ugyfelszolg]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ugyfelszolg', FILENAME = N'/var/opt/mssql/data/ugyfelszolg.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'ugyfelszolg_log', FILENAME = N'/var/opt/mssql/data/ugyfelszolg_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [ugyfelszolg] SET  ENABLE_BROKER 
GO
...
ALTER DATABASE [ugyfelszolg] SET RECOVERY FULL 
GO
...
ALTER DATABASE [ugyfelszolg] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE [ugyfelszolg] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [ugyfelszolg] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [ugyfelszolg] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [ugyfelszolg] SET QUERY_STORE = OFF
GO
